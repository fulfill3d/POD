...
var host = new HostBuilder()
    ...
    .ConfigureServices((context, services) =>
    {
        ...
        services.RegisterServices(
            ...
            (tokenOptions) =>
            {
                tokenOptions.Read = configuration["AuthScope_Seller_Product_Read"] ?? string.Empty;
                tokenOptions.Write = configuration["AuthScope_Seller_Product_Write"] ?? string.Empty;
            }
            );
    })
    .Build();
