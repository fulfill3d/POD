...
var host = new HostBuilder()
    ...
    .ConfigureServices((context, services) =>
    {
        ...
        services.RegisterServices(
            ...
            (tokenOptions) =>
            {
                tokenOptions.Read = configuration["AuthScope_Seller_Address_Read"] ?? string.Empty;
                tokenOptions.Write = configuration["AuthScope_Seller_Address_Write"] ?? string.Empty;
            });
    })
    .Build();
